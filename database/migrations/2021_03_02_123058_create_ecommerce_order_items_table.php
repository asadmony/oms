...
class CreateEcommerceOrderItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('ecommerce_order_items', function (Blueprint $table) {
            ...
            // $table->decimal('unit_pro_discount',10,2)->default(0);


            // $table->decimal('total_pro_discount',10,2)->default(0);

            // $table->decimal('total_deal_discount',10,2)->default(0);
            ...
            // $table->decimal('price',10,2)->default(0); //per unit
            // $table->decimal('total_price',10,2)->default(0); //p * q
            // //will be shown to lead owener (as if paid)

            // $table->decimal('pp',10,2)->default(0); //per unit
            // $table->decimal('total_pp',10,2)->default(0); //pp * q

            // $table->decimal('price_with_pp',10,2)->default(0); //per unit
            // $table->decimal('total_price_with_pp',10,2)->default(0); // .. * q

            // $table->decimal('total_paid_price',10,2)->default(0);

            // $table->decimal('total_paid_pp',10,2)->default(0);
            // $table->decimal('total_paid_price_with_pp',10,2)->default(0);

            // $table->decimal('total_weight',10,2)->default(0);

            // $table->decimal('order_confirmed_price',10,2)->default(0);
            // //will be shown to lead dealer
