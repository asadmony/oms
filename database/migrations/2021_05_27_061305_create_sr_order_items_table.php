...
class CreateSrOrderItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sr_order_items', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('sr_order_id')->unsigned()->nullable();
    ...
    {
        Schema::dropIfExists('sr_order_items');
    }
}
