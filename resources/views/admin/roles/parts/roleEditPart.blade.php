        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">@if ($type == 'depo')
                  GM
            @elseif($type == 'distributor')
            Distributor
            @elseif($type == 'dealer')
...
<div class=" form-group has-feedback{{ $errors->has('dealer') ? ' has-error' : '' }}">
  ...
  <div class=" form-group has-feedback{{ $errors->has('monthly_target') ? ' has-error' : '' }}">
   ...
   <input class="form-control" type="number" name="monthly_target" id="monthly_target" value="{{ old('monthly_target') ?? $admin->monthly_target }}" placeholder="ex. 100000">
</div>
        ...
        <div class="card card-widget">
          ...
          <div class="card-body">
            <ul class="list-group">
              ...
              <li class="list-group-item">{{ $com->category->name ?? '' }} : {{ $com->commission }}%</li>
          ...
          <div class="form-group pb-3 border-bottom">
            <div class="input-group">
                <label class="col-sm-5 form-check-label" for="active">
                  <input class="form-check-input" type="checkbox" id="active_cat_{{ $category->id }}" onchange="toggleCatComission({{ $category->id }},{{ $category->sr_commission }})">
                    {{ $category->name ?? '' }}
                </label>
                <input class="col-sm-7 form-control" type="number" min="0"  max="100" step="0.01" value="" name="category_{{ $category->id }}" id="category_{{ $category->id }}">
                <div class="input-group-append">
