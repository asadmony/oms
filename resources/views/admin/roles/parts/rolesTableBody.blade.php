    ...
    <tr class="nowrap">
        ...
        @if ($type == 'agent')
        <div class="btn-group">
            <a type="button" class="btn btn-primary" href="{{ route('admin.roleEdit',['type' => $type, 'role' => $admin->id]) }}"><i class="fa fa-edit"></i></a>
        ...
        @else
        <a class="btn-" href="{{ route('admin.roleEdit',['type' => $type, 'role' => $admin->id]) }}"><i class="fa fa-edit"></i></a>
        @endif
        </td>
