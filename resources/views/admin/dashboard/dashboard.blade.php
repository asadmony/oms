        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="{{ route('admin.ecommerce.orders') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box w3-orange">
              ...
              <a href="{{ route('admin.collections') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success ">
              ...
              <a href="{{ route('admin.commissionList') }}" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
...
<script>
  $(function () {
     ...
     */
     ...
     axios.get(window.location.origin+'/admin/dashboard/chart-data/get').then(res => {
      if (res.status == 200) {
    ...
    //data from axios
    var areaChartData = res.data.paymentChartData
    ...
    //data from axios
    var donutData        = res.data.orderChartData
    ...
    var pieData        = res.data.orderChartData;
    var pieOptions     = {
      maintainAspectRatio : false,
      responsive : true,
    }
